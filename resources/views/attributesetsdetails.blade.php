...
@section('page_heading','Fill The Attribute Set ID')
@section('section')
        ...
        <div class="row">
            ...
            @section ('pane2_panel_body')
                ...
                <!-- /.panel -->
                    ...
                    <form action = "/attributesets/18" method = "post">
                                ...
                                <td>
                                    <select name="attributeID" id="attributeID">
                                        ...
                                        foreach ($phparray as $value){?>
                                            <option value="<?php echo $value['attribute_set_id'] ?>"><?php echo $value['name'] ?></option>
                                            <?php
                                            //print_r($value[]);
